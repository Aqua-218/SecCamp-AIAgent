...
require_sha256 "${worker}" '077461e5defdc1917a16b40ccd48d7dc55b67f9dd4c3ce123fcca3ffd351529d'
require_sha256 "${recovery}" '1ba6404050d1471066a108e2ea0e7122080178173ee47362fa8945333758cae0'
require_sha256 "${single_worker}" '81933b3325bfefb41583a963a2c6057bcd20a3fb7206434305726aab022cef9c'
