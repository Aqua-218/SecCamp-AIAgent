...
require_sha256 "${worker}" 'e43cae012a6fc951c9de27813fa3f0d0bf42e412131946e1d257b4c302a77f0c'
require_sha256 "${recovery}" '1ba6404050d1471066a108e2ea0e7122080178173ee47362fa8945333758cae0'
require_sha256 "${single_worker}" '8abfec2f6ce78a641ee90461a198dd99fe1423626d28acbbff3ffbb92044879f'
...
require_sha256 "${deployment_readme}" '6915191057c8e219dc636a420a4ffdb7ebeb765213e5ad0dfc9875497723e554'
...
require_line "${worker}" 'DeviceAllow=/dev/kvm rwm'
require_line "${worker}" 'DeviceAllow=/dev/net/tun m'
require_line "${worker}" 'DeviceAllow=/dev/userfaultfd m'
reject_line "${worker}" 'DeviceAllow=/dev/net/tun rw'
reject_line "${worker}" 'DeviceAllow=/dev/net/tun rwm'
reject_line "${worker}" 'DeviceAllow=/dev/userfaultfd rw'
reject_line "${worker}" 'DeviceAllow=/dev/userfaultfd rwm'
...
require_line "${recovery}" 'DeviceAllow=/dev/kvm rw'
...
require_line "${single_worker}" 'DeviceAllow=/dev/kvm rwm'
require_line "${single_worker}" 'DeviceAllow=/dev/net/tun m'
require_line "${single_worker}" 'DeviceAllow=/dev/userfaultfd m'
reject_line "${single_worker}" 'DeviceAllow=/dev/net/tun rw'
reject_line "${single_worker}" 'DeviceAllow=/dev/net/tun rwm'
reject_line "${single_worker}" 'DeviceAllow=/dev/userfaultfd rw'
reject_line "${single_worker}" 'DeviceAllow=/dev/userfaultfd rwm'
