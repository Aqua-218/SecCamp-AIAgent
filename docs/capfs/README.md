...
| [backing への実 I/O](runtime-backing-io.md) | [`crates/capfs/src/runtime.rs`](../../crates/capfs/src/runtime.rs) | root fd 相対の解決、毎回の kind / mount / nlink 検査、create と rename の原子性 |
